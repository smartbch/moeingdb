...
func (t *Tree) First() (k []byte, v int64) {
	if q := t.first; q != nil {
		q := &q.d[0]
		k, v = q.k, q.v
	}
...
func (t *Tree) Get(k []byte) (v int64, ok bool) {
	q := t.r
	if q == nil {
		return
	}
...
func (t *Tree) insert(q *d, i int, k []byte, v int64) *d {
	t.ver++
	c := q.c
	if i < c {
...
// (zero-value, zero-value) if the tree is empty.
func (t *Tree) Last() (k []byte, v int64) {
	if q := t.last; q != nil {
		q := &q.d[q.c-1]
		k, v = q.k, q.v
	}
...
func (t *Tree) overflow(p *x, q *d, pi, i int, k []byte, v int64) {
	t.ver++
	l, r := p.siblings(pi)
...
// func (t *Tree) SafeSet(k []byte, v int64) {
// 	t.buf = append(t.buf, k...) //make a copy
// 	t.Put(t.buf, func(oldV int64, exists bool) (newV int64, write bool) {
// 		write = true
// 		newV = v
...
func (t *Tree) Set(k []byte, v int64) {
	//dbg("--- PRE Set(%v, %v)\n%s", k, v, t.dump())
	//defer func() {
	//	dbg("--- POST\n%s\n====\n", t.dump())
	//}()
...
func (t *Tree) PutNewAndGetOld(k []byte, newV int64) (oldV int64, oldVExists bool) {
	oldV, _ = t.Put(k, func(old int64, exists bool) (int64, bool) {
		oldVExists = exists
		return newV, true
	})
	return
...
func (t *Tree) Put(k []byte, upd func(oldV int64, exists bool) (newV int64, write bool)) (oldV int64, written bool) {
	pi := -1
	var p *x
	q := t.r
	var newV int64
...
func (t *Tree) split(p *x, q *d, pi, i int, k []byte, v int64) {
	t.ver++
	r := btDPool.Get().(*d)
	if q.n != nil {
		r.n = q.n
...
// io.EOF is returned.
func (e *Enumerator) Next() (k []byte, v int64, err error) {
...
// == io.EOF is returned.
func (e *Enumerator) Prev() (k []byte, v int64, err error) {
	if err = e.err; err != nil {
		return
	}
